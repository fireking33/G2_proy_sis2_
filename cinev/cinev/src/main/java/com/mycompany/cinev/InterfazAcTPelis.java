...
public class InterfazAcTPelis extends javax.swing.JFrame {
  ...
  private Conexion conexion = new Conexion();
    ...
    private void initComponents() {
        ...
        clasifLbl1 = new javax.swing.JLabel();
        ...
        clasifPanelLayout.setHorizontalGroup(
            ...
            .addGroup(clasifPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(clasif, 0, 290, Short.MAX_VALUE))
        );
        clasifPanelLayout.setVerticalGroup(
            clasifPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(clasifPanelLayout.createSequentialGroup()
                .addGroup(clasifPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(clasifLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        bg.add(clasifPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 310, 410, 40));
        ...
        bg.add(tituloACtLB, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 50, 390, 40));
        ...
        bg.add(cancelarBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 430, 180, 50));
        ...
        bg.add(actualizarBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 430, 180, 50));

        panelFormato.setBackground(new java.awt.Color(102, 0, 102));

        clasifLbl1.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 18)); // NOI18N
        clasifLbl1.setForeground(new java.awt.Color(255, 255, 255));
        clasifLbl1.setText("Formato:");
        ...
        panelFormatoLayout.setHorizontalGroup(
            ...
            .addGroup(panelFormatoLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(clasifLbl1, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panelFormatoLayout.setVerticalGroup(
            ...
            .addGroup(panelFormatoLayout.createSequentialGroup()
                .addGroup(panelFormatoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(clasifLbl1, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(formato, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(0, 7, Short.MAX_VALUE))
        );

        bg.add(panelFormato, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 360, 410, 50));
    ...
    // Validación si ya existe la película
    boolean tituloDemasiadoLargo = InterfazRegPeli.largo(titulo.getText());
    boolean fechaValida = InterfazRegPeli.verificarAnio(fechaEs.getText());
    ...
    if (camposVacios) mensajeError.append("- Por favor llene todos los campos.\n");
    if (!tituloValido) mensajeError.append("- El título solo puede contener letras y espacios.\n");
    if (tituloDemasiadoLargo) mensajeError.append("- El título es demasiado largo.\n");
    if (fechaValida) mensajeError.append("- Ingrese una fecha válida (Máximo este año).\n");
    if (!duracionValida) mensajeError.append("- La duración debe ser un número entre 10 y 499 minutos.\n");
    if (!generoValido) mensajeError.append("- El género solo puede contener letras y espacios.\n");
    if (faltaFoto) mensajeError.append("- Debe subir una imagen.\n");
    

    // Si hay errores, mostrar el mensaje y salir del método
    if (mensajeError.length() > 0) {
        JOptionPane.showMessageDialog(null, mensajeError.toString(), "Advertencia", JOptionPane.WARNING_MESSAGE);
        return;
    }

    // Actualizar la película
    actualizarPelicula(nomPeli, titulo.getText(), fechaEs.getText(), genero.getText(), duracionNum, clasif.getSelectedItem().toString(), paraFoto, formato.getSelectedItem().toString());
    JOptionPane.showMessageDialog(this, "Datos actualizados correctamente!", "Éxito", JOptionPane.INFORMATION_MESSAGE);

    // Mostrar la interfaz de administración y cerrar la actual
   ...
   public void actualizarPelicula(String nombrePelicula, String titulo, String fechaEstreno, String genero, int duracion, String clasificacion, JLabel paraFoto, String formato) {
    Connection con = conexion.establecerConexion();
    String sql = "UPDATE pelicula SET nombre_pelicula=?, fecha_estreno=?, genero=?, duracion=?, clasificacion=?, imagen=?, formato=? WHERE nombre_pelicula=?";

    // Convertir la imagen del JLabel en byte[]
    byte[] imagen = convertirImagenLabelABytes(paraFoto);
    
    try (PreparedStatement pst = con.prepareStatement(sql)) {
        pst.setString(1, titulo);
        pst.setDate(2, java.sql.Date.valueOf(fechaEstreno));
        pst.setString(3, genero);
        pst.setInt(4, duracion);
        pst.setString(5, clasificacion);
        pst.setBytes(6, imagen);
        pst.setString(7, formato);
        pst.setString(8, nombrePelicula);
        ...
        JOptionPane.showMessageDialog(null, "Error al actualizar la película: " + e.getMessage());
    } finally {
        try {
   ...
   public boolean compararImagenes(byte[] img1, byte[] img2) {
    if (img1 == null && img2 == null){ System.out.println(Arrays.toString(img1)+" "+Arrays.toString(img2)); return true;}
    if (img1 == null || img2 == null) {System.out.println(Arrays.toString(img1)+" "+Arrays.toString(img2)); return false;}
    System.out.println(Arrays.toString(img1)+" "+Arrays.toString(img2));
    return Arrays.equals(img1, img2);
}

   public byte[] convertirImagenLabelABytes(JLabel label) {
    if (label.getIcon() instanceof ImageIcon) {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            String formato = detectarFormato(icon);
            if (formato == null) formato = "png"; // Si no se detecta, usar PNG por defecto
   ...
   public String detectarFormato(ImageIcon icon) {
    // Array de formatos de imagen permitidos
    String[] formatosValidos = {"png", "jpg", "jpeg"};

    String descripcion = icon.getDescription(); // Intentar obtener la extensión
    if (descripcion != null) {
        descripcion = descripcion.toLowerCase(); // Convertir a minúsculas
        for (String formato : formatosValidos) {
            if (descripcion.endsWith("." + formato)) {
                return formato; // Retorna el formato correcto
            }
        }
    }
    return null; // No se pudo detectar el formato
}
    ...
    private javax.swing.JLabel clasifLbl1;
