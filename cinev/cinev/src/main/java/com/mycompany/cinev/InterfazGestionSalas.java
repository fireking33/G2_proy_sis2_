...
public class InterfazGestionSalas extends javax.swing.JFrame {
  ...
  private Conexion conexion = new Conexion();
    ...
    private void initComponents() {
        ...
        bg.add(tituloGestionSalas, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 70, 400, 40));
        ...
        aniadirBtn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        bg.add(aniadirBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 190, 190, 50));

        subTituloaniadir.setBackground(new java.awt.Color(13, 20, 58));
        subTituloaniadir.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        subTituloaniadir.setForeground(new java.awt.Color(255, 255, 255));
        subTituloaniadir.setText("Añadir Sala:");
        bg.add(subTituloaniadir, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 170, 30));

        subTituloAdFun.setBackground(new java.awt.Color(13, 20, 58));
        subTituloAdFun.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        subTituloAdFun.setForeground(new java.awt.Color(255, 255, 255));
        subTituloAdFun.setText("Administrar Funciones de Salas:");
        bg.add(subTituloAdFun, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, 400, 30));
        ...
        bg.add(salasCombobox, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 340, 390, 30));
    ...
    private void agregarSala() {
        ...
        String countSql = "SELECT COUNT(*) FROM sala;";
          String insertSql = "INSERT INTO sala (nombre_sala, capacidad) VALUES (?, ?) RETURNING id_sala;";
        ...
        try {
            ...
            if (rsCount.next()) {
                totalSalas = rsCount.getInt(1);
            }

            rsCount.close();
            countStmt.close();

            // Validar que no se superen las 10 salas
            if (totalSalas >= 10) {
                JOptionPane.showMessageDialog(this, "No se pueden agregar más salas. El límite es 10.", "Límite alcanzado", JOptionPane.WARNING_MESSAGE);
                return;
            }

            // Nombre de la nueva sala (se genera automáticamente)
            String nombreSala = "Sala " + (totalSalas + 1);
            int capacidad = 216; // Capacidad fija

            // Insertar la nueva sala
            PreparedStatement insertStmt = con.prepareStatement(insertSql);
            insertStmt.setString(1, nombreSala);
            insertStmt.setInt(2, capacidad);

            ResultSet rsInsert = insertStmt.executeQuery();

            if (rsInsert.next()) {
                JOptionPane.showMessageDialog(this, "Sala " + (totalSalas + 1) + " añadida con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                cargarSalas(); // Actualizar el JComboBox con las nuevas salas
            } else {
    ...
    private void administrarBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_administrarBtnMouseEntered
        administrarBtn.setBackground(Color.blue);
    ...
    private void administrarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_administrarBtnActionPerformed
       String noms = salasCombobox.getSelectedItem().toString();
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazGestionFunciones(noms).setVisible(true);
            }
        });
