...
public class InterfazRegPeli extends javax.swing.JFrame {
  ...
  private Conexion conexion = new Conexion();
    ...
    private void initComponents() {
        ...
        guardarBtn.setBackground(new java.awt.Color(153, 153, 0));
        ...
        bg.add(guardarBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 410, 170, 40));
        ...
        bg.add(jToggleButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 410, 170, 40));
 ...
 public  boolean existePelicula(String nombrePelicula, Connection conexion) {
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
      ...
      private boolean largo(String max){
          int lar = max.length();
          if(lar>31){
              return true;
          }
